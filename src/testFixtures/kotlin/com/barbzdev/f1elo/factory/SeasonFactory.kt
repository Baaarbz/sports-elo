...
object SeasonFactory {
  private val seasons = listOf(
    Season.create(
      year = 1950,
      infoUrl = "http://en.wikipedia.org/wiki/1950_Formula_One_season"
    ).addRacesOfSeason(RaceFactory.races),
    Season.create(
      year = 2006,
      infoUrl = "http://en.wikipedia.org/wiki/2006_Formula_One_season"
    ).addRacesOfSeason(RaceFactory.races),
    Season.create(
      year = 2014,
      infoUrl = "http://en.wikipedia.org/wiki/2014_Formula_One_season"
    ).addRacesOfSeason(RaceFactory.races),
    Season.create(
      year = 2021,
      infoUrl = "https://en.wikipedia.org/wiki/2021_Formula_One_World_Championship"
    ).addRacesOfSeason(RaceFactory.races),
  )
  ...
  fun aSeason(year: Int) =
    Season.create(
      year = year,
      infoUrl = "https://en.wikipedia.org/wiki/${year}_Formula_One_World_Championship"
    ).addRacesOfSeason(RaceFactory.races)

  val f1Seasons = listOf(
    F1Season(
      season = 1950,
  ...
  fun aF1Season(year: Int) = F1Season(
    season = year,
