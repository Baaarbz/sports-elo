...
class ConstructorMapper : EntityMapper<Constructor, ConstructorEntity> {
  ...
  override fun toEntity(domain: Constructor): ConstructorEntity = ConstructorEntity(
    id = domain.id().value,
  ...
  override fun toDomain(entity: ConstructorEntity): Constructor = Constructor.create(
    id = entity.id,
    name = entity.name,
