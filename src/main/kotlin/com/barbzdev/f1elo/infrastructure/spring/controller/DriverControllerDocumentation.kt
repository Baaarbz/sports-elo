...
interface DriverControllerDocumentation {
  ...
  @Operation(
    ...
    parameters = [Parameter(
      name = "page",
      description = "Page number from 0 to (nPages - 1)",
      required = false,
      example= "0"
    ), Parameter(
      name = "pageSize",
  ...
  fun getDriversListing(page: Int, pageSize: Int, sortBy: String, sortOrder: String): ResponseEntity<HttpGetDriverListingResponse>
}
